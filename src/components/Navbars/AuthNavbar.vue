    ...
    >
      ...
      >
        <router-link
          ...
          to="/"
        >
          <div class="logo_container" style="width:20%">
            <img src="@/assets/img/logo_school.svg" alt="logo">
          </div>
        </router-link>
        <button
      ...
      >
        <!-- <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            ...
            >
              <img src="@/assets/img/vue.jpg" alt='logo'
                class="mr-2"
              />
              Docs
            </a>
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center mr-2">
            <router-link to="/about" class="font-bold text-blueGray-500">
                Про нас
              </router-link>
          </li>
          <!-- <li class="flex items-center">
            <a
              class="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
              href="https://www.facebook.com/VechSH"
              target="_blank"
            >
              <i
